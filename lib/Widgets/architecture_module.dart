...
class ArchitectureModal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BackdropFilter(
      filter: ImageFilter.blur(sigmaX: 5, sigmaY: 5), // The Glassmorphism blur
      child: Dialog(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Material(
                  // Added Material for InkWell ripple effect
                  color: Colors.transparent,
                  child: InkWell(
                    borderRadius: BorderRadius.circular(8),
                    mouseCursor: SystemMouseCursors
                        .zoomIn, // Changes mouse cursor on web
                    onTap: () {
                      // Pushes the full-screen viewer with a seamless fade transition
                      Navigator.of(context).push(
                        PageRouteBuilder(
                          opaque:
                              false, // Keeps the background transparent during transition
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        // The "Expand" Icon in the top right corner
                        Positioned(
                          top: 12,
                          right: 12,
                          child: Container(
